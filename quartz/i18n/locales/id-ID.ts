  ...
  pages: {
    ...
    folderContent: {
      ...
      itemsUnderFolder: ({ count }) =>
        count === 1 ? "1 item dalam folder ini." : `${count} item dalam folder ini.`, // default: "1 item under this folder." : `${count} items under this folder.`
    },
    tagContent: {
      tag: "Tag",
      tagIndex: "Tag Index",
      itemsUnderTag: ({ count }) =>
        count === 1 ? "1 item dengan tag ini." : `${count} dengan tag ini.`, // default: "1 item with this tag." : `${count} items with this tag.`
